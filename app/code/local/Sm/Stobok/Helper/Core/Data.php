...
class Sm_Stobok_Helper_Core_Data extends Mage_Core_Helper_Data
{
    const XML_PATH_MINIFY_ENABLE_YUICOMPRESSOR  = 'stobok_cfg/advanced/enable_yuicompressor';
	const XML_PATH_MINIFY_ENABLE                = 'stobok_cfg/advanced/compress_css_js';
