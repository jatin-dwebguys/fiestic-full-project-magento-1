...
-------------------------------------------------------------------------*/
//die('aaa');
class Sm_Stobok_Model_Observer {

	public function less_compile( $observer ){	
	
		$setting = Mage::helper('stobok/data');
		$less_theme_compile     = Mage::getStoreConfig('stobok_cfg/advanced/less_compile');
		$preset_name 			= Mage::getStoreConfig('stobok_cfg/general/color');
		$device_responsive      = Mage::getStoreConfig('stobok_cfg/general/device_responsive'); 
		$direction      		= Mage::getStoreConfig('stobok_cfg/general/direction');
